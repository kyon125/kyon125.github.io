    ...
    execute: function () {
      ...
      var Saber = exports('Saber', /*#__PURE__*/function (_Arms) {
        ...
        _proto.Attack = /*#__PURE__*/function () {
          var _Attack = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(attackerSeat) {
            var _this3 = this;
                ...
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    return new Promise( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(res) {
                      var seats, charas, targets, _loop, i, _i, a;
                        ...
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            case 0:
                              ...
                              seats = _this3.GetAttackRange(attackerSeat);
                              charas = _this3.gamemanager.SearchCharacterInSeat(seats);
                              targets = [];
                            ...
                            case 24:
                              _this3.gamemanager.isAttack = false;
                              res();
        ...
        _proto.ComboAttack = /*#__PURE__*/function () {
          var _ComboAttack = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(attackerSeat, target) {
            var _this4 = this;
                ...
                switch (_context6.prev = _context6.next) {
                  ...
                  case 3:
                    ...
                    return new Promise(function (res) {
                      ...
                      _this4.viewer.PlayCharacterAnimation(_this4.characterData, Status.Attack, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        _proto.GetDamage = /*#__PURE__*/function () {
          var _GetDamage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(damageValue) {
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  ...
                  case 13:
                    ...
                    this.viewer.RefreshCurrentCharacterInfo(this.characterData);
                    this.viewer.PlayCharacterAnimation(this.characterData, Status.damage, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      ...
      var Archer = exports('Archer', /*#__PURE__*/function (_Arms2) {
        ...
        _proto2.ComboAttack = /*#__PURE__*/function () {
          var _ComboAttack2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(attackerSeat, target) {
            var _this6 = this;
                ...
                switch (_context10.prev = _context10.next) {
                  ...
                  case 3:
                    ...
                    return new Promise(function (res) {
                      ...
                      _this6.viewer.PlayCharacterAnimation(_this6.characterData, Status.Attack, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
        ...
        _proto2.Attack = /*#__PURE__*/function () {
          var _Attack2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(attackerSeat) {
            var _this8 = this;
              ...
              while (1) {
                switch (_context14.prev = _context14.next) {
                  case 0:
                    ...
                    //     this.viewer.RefreshCurrentCharacterInfo(this.characterData);
                    //     let seats = this.GetAttackRange(attackerSeat);
                    //     let charas = this.gamemanager.SearchCharacterInSeat(seats);
                    //     let targets: Character[] = [];
                    //     this.viewer.PlayCharacterAnimation(this.characterData, Status.Attack, async () => {
                    //         for (let i = 0; i < charas.length; i++) {
                    //             if (charas[i].tag !== this.characterData.tag) {
                    //                 this.viewer.ShowAttackHitEffect(this.gamemanager.GetMapPos(charas[i].seat), "Effect_Hit")
                    //                 await charas[i].Arm.GetDamage(this.characterData.currentAtk);
                    //                 targets.push(charas[i]);
                    //             }
                    //         }
                    //         for (let i = 0; i < targets.length; i++) {
                    //             for (let a = 0; a < this.gamemanager.charatersData.length; a++) {
                    //                 if (this.gamemanager.charatersData[a].tag == this.characterData.tag && this.characterData != this.gamemanager.charatersData[a]) {
                    //                     await this.gamemanager.charatersData[a].Arm.ComboAttack(this.gamemanager.charatersData[a].seat, targets[i]);
                    //                 }
                    //             }
                    //         }
                    //         res();
                    ...
                    this.viewer.HideBehaviorBtn();
                    _context14.next = 3;
                    return new Promise( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(res) {
                      var seats, charas, targets, _loop2, i, _i2, a;
                        ...
                        while (1) {
                          switch (_context13.prev = _context13.next) {
                            case 0:
                              ...
                              seats = _this8.GetAttackRange(attackerSeat);
                              charas = _this8.gamemanager.SearchCharacterInSeat(seats);
                              targets = [];
                                    ...
                                    switch (_context12.prev = _context12.next) {
                                      case 0:
                                        ...
                                        return new Promise(function (res) {
                                          ...
                                          _this8.viewer.PlayCharacterAnimation(_this8.characterData, Status.Attack, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
                            ...
                            case 6:
                              ...
                              return _context13.delegateYield(_loop2(i), "t0", 8);
                            ...
                            case 24:
                              _this8.gamemanager.isAttack = false;
                              res();
        ...
        _proto2.GetDamage = /*#__PURE__*/function () {
          var _GetDamage2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(damageValue) {
            var calculateValue, i;
              ...
              while (1) {
                switch (_context16.prev = _context16.next) {
                  ...
                  case 13:
                    ...
                    this.viewer.RefreshSmallCharacterStatus(this.characterData);
                    this.viewer.RefreshCurrentCharacterInfo(this.characterData);
                    this.viewer.PlayCharacterAnimation(this.characterData, Status.damage, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
    ...
    execute: function () {
      ...
      var GameManager = exports('GameManager', (_dec = ccclass('GameManager'), _dec2 = property(CCString), _dec3 = property(Node), _dec4 = property(Seat), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Character), _dec9 = property(Player), _dec10 = property(Character), _dec11 = property(Seat), _dec12 = property(Card), _dec13 = property(CardManager), _dec14 = property(EffectManager), _dec15 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.start = function start() {
          ...
          this.viewer.Initial(this); // setTimeout(() => {
          // }, 100);
        };
        ...
        _proto.Initial = function Initial() {
          ...
          if (GameData.Instance.currentStage == GameData.Instance.stageCharatersData.length - 1) SoundManager.Instance.PlayBGM("MainBattle", true);else SoundManager.Instance.PlayBGM("MainBattle02", true);
          ...
          layout.updateLayout(); //Initial Character

          var _loop = function _loop(_i) {
            var node = instantiate(_this2.charaterPrefab);
            _this2.charatersData[_i].prefab = node;

            _this2.charaters.addChild(node);

            node.setPosition(_this2.map.children[SeatConvertMapSeat(_this2.charatersData[_i].seat, _this2.mapRange)].position);
            var character = _this2.charatersData[_i];

            switch (character.armTag) {
              case "Saber":
                {
                  character.Arm = new Saber(character, _this2, _this2.viewer);
                  break;
                }

              case "Archer":
                {
                  character.Arm = new Archer(character, _this2, _this2.viewer);
                  break;
                }
            }

            character.prefab.getChildByName("Btn_character").on(Node.EventType.MOUSE_UP, function () {
              if (_this2.isDrop && !_this2.isAttack) {
                var success = _this2.UseEffectSuccess(character);

                if (success) {
                  _this2.viewer.UseCard();

                  _this2.viewer.RefreshCurrentPlayerInfo(_this2.playerData);
                }
            ...
            _this2.viewer.InitialSmallCharacterStatus(character);
          };
        ...
        _proto.RegisterButton = function RegisterButton() {
          ...
          this.charatersData.forEach(function (character) {
            character.prefab.getChildByName("Btn_character").on(Node.EventType.MOUSE_ENTER, function () {
              if (character.tag != "Enemy") {
                if (_this3.selectCharaterData == null) _this3.viewer.RenderAttackRange(character.Arm.GetAttackRange(character.seat), Color.YELLOW);else if (_this3.selectCharaterData == character) _this3.viewer.RenderAttackRange(character.Arm.GetAttackRange(_this3.targetSeat), Color.YELLOW);else _this3.viewer.RenderAttackRange(character.Arm.GetAttackRange(character.seat), Color.YELLOW);
              }
          ...
          var _loop2 = function _loop2(i) {
            var seat = MapSeatConvertSeat(i, _this3.mapRange);

            _this3.map.children[i].on(Node.EventType.MOUSE_DOWN, function () {
              if (_this3.turnStatus == "Friendly") {
                if (_this3.mapData.SearchSeatCanArrived(seat)) {
                  console.log("可以移動到這裡");
                  _this3.targetSeat = MapSeatConvertSeat(i, _this3.mapRange);
                  SoundManager.Instance.PlaySEFX("SEFX_FriendMove");
                  tween(_this3.selectCharaterData.prefab).set({
                    position: _this3.map.children[i].position
                  }).start();
                } else {
                  console.log("不可以移到這裡");

                  if (_this3.selectCharaterData !== null) {
                    _this3.selectCharaterData.behaviorStatus = "idel";

                    _this3.mapData.Initial();

                    _this3.viewer.CancelShowRange();

                    SoundManager.Instance.PlaySEFX("SEFX_Cancel");
                    tween(_this3.selectCharaterData.prefab).set({
                      position: _this3.map.children[SeatConvertMapSeat(_this3.selectCharaterData.seat, _this3.mapData.mapRange)].position
                    }).start();
                    _this3.selectCharaterData = null;
                  }
                }
        ...
        _proto.TouchMove = function TouchMove(character) {
          ...
          if (character.tag != "Enemy") {
            if (character.behaviorStatus === "idel") {
              ...
              this.viewer.RefreshCurrentCharacterInfo(character);
            } else {
        ...
        _proto.SearchCharacterInSeat = function SearchCharacterInSeat(seats) {
          ...
          seats.forEach(function (seat) {
            for (var i = 0; i < _this5.charatersData.length; i++) {
              if (seat.x === _this5.charatersData[i].seat.x && seat.y === _this5.charatersData[i].seat.y) {
                characters.push(_this5.charatersData[i]);
                break;
              }
            }
          });
                  ...
                  case 0:
                    ...
                    this.charatersData.forEach(function (data) {
                      if (data.tag == "Enemy") {
                        ...
                        _this6.viewer.RefreshSmallCharacterStatus(data);
                      }
                    });
                        ...
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              ...
                              if (!(_this6.charatersData[i].tag === "Enemy")) {
                                _context.next = 37;
                                break;
                              } ///攻擊目標里有敵人時，進行攻擊
                              ...
                              canAtttack = false;
                              charas = _this6.SearchCharacterInSeat(_this6.charatersData[i].Arm.GetAttackRange(_this6.charatersData[i].seat));
                              _i2 = 0;
                            ...
                            case 13:
                              ...
                              _context.next = 16;
                              return _this6.charatersData[i].Arm.Attack(_this6.charatersData[i].seat);
                            ...
                            case 18:
                              ...
                              return new Promise(function (res) {
                                ...
                                var _loop4 = function _loop4(a) {
                                  if (_this6.charatersData[a].tag !== "Enemy") {
                                    //console.log("ddddd");
                                    var moveRange = [[-1, 0], [1, 0], [0, 1], [0, -1]];
                                    var seats = [];
                                    moveRange.forEach(function (element) {
                                      //console.log("sssss");
                                      var seat = _this6.charatersData[a].seat.Add(element);

                                      if (seat.x >= 0 && seat.x < _this6.mapRange.x && seat.y >= 0 && seat.y < _this6.mapRange.y) seats.push(seat);
                                    });
                                    seats.forEach(function (seat) {
                                      //console.log(seat);
                                      if (_this6.mapData.BigMap[seat.y][seat.x]) {
                                        if (target == null) {
                                          target = {
                                            distant: targetDistance(_this6.charatersData[i].seat, seat),
                                            data: _this6.charatersData[a],
                                            targetSeat: seat
                                          };
                                        } else if (targetDistance(_this6.charatersData[i].seat, seat) <= target.distant) {
                                          target = {
                                            distant: targetDistance(_this6.charatersData[i].seat, seat),
                                            data: _this6.charatersData[a],
                                            targetSeat: seat
                                    ...
                                    if (target == null) {
                                      target = {
                                        distant: targetDistance(_this6.charatersData[i].seat, _this6.charatersData[a].seat),
                                        data: _this6.charatersData[a],
                                        targetSeat: _this6.charatersData[a].seat
                                      };
                                    }
                                  }
                                };

                                for (var a = 0; a < _this6.charatersData.length; a++) {
                                  _loop4(a);
                                }

                                _this6.mapData.MoveInitial(_this6.charatersData[i].seat, _this6.charatersData[i].currentMoveRange);

                                var targetMoveSeat = null; //console.table("目標:");
                                //console.table(target.targetSeat);

                                for (var _i3 = 0; _i3 < _this6.mapRange.y; _i3++) {
                                  for (var _a = 0; _a < _this6.mapRange.x; _a++) {
                                    if (_this6.mapData.moveMap[_i3][_a].canArrvied) {
                                ...
                                if (targetMoveSeat.seat != null) if (!targetMoveSeat.seat.CheakTheSame(_this6.charatersData[i].seat)) {
                                  _this6.charatersData[i].seat = targetMoveSeat.seat;

                                  var pos = _this6.mapSprite[SeatConvertMapSeat(targetMoveSeat.seat, _this6.mapData.mapRange)].node.position;

                                  SoundManager.Instance.PlaySEFX("SEFX_EnemyMove");
                                  var obj = _this6.charatersData[i].prefab;
                                  ...
                                  tween(_this6.charatersData[i].prefab).by(0.2, {
                                    position: new Vec3(pos.x - _this6.charatersData[i].prefab.position.x, 0, 0)
                                  }).by(0.2, {
                                    position: new Vec3(0, pos.y - _this6.charatersData[i].prefab.position.y, 0)
                                  }).call(res).start();
                                } else res();
                              });
                            ...
                            case 20:
                              ...
                              _canAtttack = false;
                              _charas = _this6.SearchCharacterInSeat(_this6.charatersData[i].Arm.GetAttackRange(_this6.charatersData[i].seat));
                              _i4 = 0;
                            ...
                            case 32:
                              ...
                              console.log(_this6.charatersData[i].name + " ssss");

                              _this6.viewer.HideBehaviorBtn();
            ...
            switch (cardID) {
              ...
              case 2:
                if (target.tag == "Friendly") {
                  ...
                  this.viewer.RefreshCurrentCharacterInfo(target);
                  return true;
                }
        ...
        _proto.CheckMatch = function CheckMatch() {
          ...
          this.charatersData.forEach(function (data) {
            if (data.currentHp <= 0) {
              ...
              _this7.charatersData.splice(_this7.charatersData.indexOf(data), 1);
            }
          });
      ...
      var GameViewer = exports('GameViewer', (_dec = ccclass('GameViewer'), _dec2 = property(Camera), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(StatusViewer), _dec6 = property(StatusViewer), _dec7 = property(PlayerViewer), _dec8 = property(CardViewer), _dec9 = property(EffectManager), _dec10 = property(ResultViewer), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.RefreshCurrentCharacterInfo = function RefreshCurrentCharacterInfo(data) {
          if (data.tag === "Friendly") {
            ...
            this.EnemyStatus.CallFriendInfoShow(); //this.FriendStatus.SetHeadSprite()
          }
        };
        ...
        _proto.PlayCharacterAnimation = /*#__PURE__*/function () {
          var _PlayCharacterAnimation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, Status, callback) {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
          ...
          function PlayCharacterAnimation(_x, _x2, _x3) {
            return _PlayCharacterAnimation.apply(this, arguments);
          }

          return PlayCharacterAnimation;
        }();

        _proto.PlayCharacterDeath = /*#__PURE__*/function () {
          var _PlayCharacterDeath = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
            var view;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 5:
                    _context2.t0 = this.manager.CheckMatch();
                    _context2.next = _context2.t0 === 'Matching' ? 8 : _context2.t0 === 'Victory' ? 9 : _context2.t0 === 'Defeat' ? 11 : 13;
                    break;
          ...
          function PlayCharacterDeath(_x4) {
        ...
        _proto.CancelShowRange = function CancelShowRange() {
          ...
          for (var i = 0; i < y; i++) {
            for (var a = 0; a < x; a++) {
              this.mapViewer.RenderMapColor([new Seat(a, i)], this.manager.mapData.moveMap[i][a].canArrvied ? Color.CYAN : Color.GRAY);
            }
          }
        };
            ...
            case "moving":
              {
                ...
                this.btn_EndTurn.interactable = false;
                break;
              }
            ...
            case "idel":
              {
                ...
                this.btn_EndTurn.interactable = true;
                break;
              }
          }
        };
        ...
        _proto.HideBehaviorBtn = function HideBehaviorBtn() {
          console.log("hide"); //this.btn_EnsureMove.node.active = false;
    ...
    execute: function () {
      ...
      var PlayerViewer = exports('PlayerViewer', (_dec = ccclass('PlayerViewer'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(ProgressBar), _dec5 = property(ProgressBar), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.SetPlayerStatus = function SetPlayerStatus(playerData) {
          ...
          this.txt_Cost.string = playerData.currentCost + " / " + playerData.maxCost + " ";
        };
...
System.register("chunks:///_virtual/StatusViewer.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Sprite, Label, ProgressBar, Node, tween, Vec3, Component;
  ...
  return {
    ...
    execute: function () {
      ...
      var ccclass = _decorator.ccclass,
          property = _decorator.property;
      var StatusViewer = exports('StatusViewer', (_dec = ccclass('StatusViewer'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Sprite), _dec8 = property(ProgressBar), _dec9 = property(ProgressBar), _dec10 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function StatusViewer() {
          ...
          _initializerDefineProperty(_this, "im_Background", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "txt_HP", _descriptor2, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "txt_Block", _descriptor3, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "txt_Name", _descriptor4, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "txt_Attack", _descriptor5, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "s_Head", _descriptor6, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "bar_HP", _descriptor7, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "bar_Block", _descriptor8, _assertThisInitialized(_this));

          _initializerDefineProperty(_this, "main", _descriptor9, _assertThisInitialized(_this));
        ...
        _proto.CallFriendInfoShow = function CallFriendInfoShow() {
          ...
          tween(this.im_Background.node).to(0.15, {
        ...
        _proto.CallEnemyInfoShow = function CallEnemyInfoShow() {
          ...
          console.log("call");
          tween(this.im_Background.node).to(0.1, {
            scale: new Vec3(0, 1, 1)
          }, {
            easing: "quadOut"
          }).call(function () {
        ...
        return StatusViewer;
      }(Component), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "im_Background", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "txt_HP", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "txt_Block", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "txt_Name", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "txt_Attack", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "s_Head", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "bar_HP", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "bar_Block", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "main", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
